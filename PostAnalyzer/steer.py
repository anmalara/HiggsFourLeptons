...
analysisname     = 'HiggsFourLeptons'
user             = 'anmalara'
input_base_path  = '/user/anmalara/WorkingArea/LEAF_v2/CMSSW_10_6_28/src/LEAF/../../..'
result_base_path = '/user/anmalara/WorkingArea/LEAF_v2/CMSSW_10_6_28/src/LEAF/../../..'
